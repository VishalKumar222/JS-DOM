//code to access element which is having id as "text"
let text = document.getElementById("text");
text.innerText = "changed in dom manipulation";

//code to access element which is having tag as "h1"
let heading = document.getElementsByTagName("h1");
heading[0].innerText = "DOM ";

//code to access element which is having class as "box"
...
//Create three cards on HTML page
//Arrange them using flex property in row or horizontal direction
//create button at the bottom named "Change Flex direction".
...
//Difference between window vs document?
...
//code to implement timer clock using JAVASCRIPT .
//Display HH:MM:SS
